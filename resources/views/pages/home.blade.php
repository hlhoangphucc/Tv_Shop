                        ...
                        @foreach($slider as $key => $slide)
                            ...
                            @endphp
                                    <div class="single-slide align-center-left animation-style-02">
                                        <img alt="{{$slide->slider_desc}}" src="{{asset('uploads/slider/'.$slide->slider_image)}}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="single-banner pb-xs-30">
                                <a href="#">
                                    <img src="{{asset('frontend/home/images/banner/5.jpg')}}" alt="Li's Static Banner">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="single-banner pb-xs-30">
                                <a href="#">
                                    <img src="{{asset('frontend/home/images/banner/6.jpg')}}" alt="Li's Static Banner">
                                </a>
                            </div>
                        </div>
                        <!-- Single Banner Area End Here -->
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="single-banner">
                                <a href="#">
                                    <img src="{{asset('frontend/home/images/banner/7.jpg')}}" alt="Li's Static Banner">
                                </a>
                            </div>
                        </div>
                        <!-- Single Banner Area End Here -->
 ...
 -->
                                        ...
                                        <div class="single-product-wrap">
                                            <div class="product-image">
                                                <a href="{{URL::to('/chi-tiet-san-pham/'.$product->product_id)}}">
                                                    <img src="{{URL::to('uploads/product/'.$product->product_image)}}" alt="Li's Product Image">
                                                </a>
                                            ...
                                            <div class="product_desc">
                                                ...
                                                <div class="add-actions">
                                                    <ul class="add-actions-link">
                                                       <li class="add-cart active"><button type="button" class="btn btn-danger add-to-cart" data-id_product="{{$product->product_id}}" name="add-to-cart">Thêm giỏ hàng</button></li>
