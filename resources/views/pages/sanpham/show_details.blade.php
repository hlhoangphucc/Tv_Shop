                           ...
                           <!-- Product Details Left -->
                            <div class="product-details-left">
                                <div class="product-details-images slider-navigation-1">
                                    <div class="lg-image">
                                        <a class="popup-img venobox vbox-item" href="product/large-size/1.jpg" data-gall="myGallery">
                                ...
                                <div class="product-details-thumbs slider-thumbs-1">                                        
                                    <div class="sm-image"><img src="{{URL::to('uploads/product/'.$value->product_image)}}" alt="product image thumb"></div>
