...
use App\Http\Controllers\PaymendController;
...
Route::post('/admin-index', [AdminController::class, 'postindex']);
...
Route::get('/list-coupon', [CouponController::class, 'list-coupon']);
...
Route::post('/save-cart/{id}', [CartController::class, 'save_cart']);
Route::post('/add-cart-ajax/', [CartController::class, 'add_cart_ajax']);
Route::get('/show-cart', [CartController::class, 'gio_hang']);
...
Route::post('/order-place', [CheckoutController::class, 'del_fee']);
