...
<link rel="stylesheet" href="{{asset('frontend/home/css/material-design-iconic-font.min.css')}}">
<!-- Font Awesome -->
<link rel="stylesheet" href="{{asset('frontend/css/font-awesome.min.css')}}">
<!-- Font Awesome Stars-->
<link rel="stylesheet" href="{{asset('frontend/home/css/fontawesome-stars.css')}}">
<!-- Meanmenu CSS -->
<link rel="stylesheet" href="{{asset('frontend/home/css/meanmenu.css')}}">
<!-- owl carousel CSS -->
<link rel="stylesheet" href="{{asset('frontend/home/css/owl.carousel.min.css')}}">
<!-- Slick Carousel CSS -->
<link rel="stylesheet" href="{{asset('frontend/home/css/slick.css')}}">
<!-- Animate CSS -->
<link rel="stylesheet" href="{{asset('frontend/home/css/animate.css')}}">
<!-- Jquery-ui CSS -->
<link rel="stylesheet" href="{{asset('frontend/home/css/jquery-ui.min.css')}}">
<!-- Venobox CSS -->
<link rel="stylesheet" href="{{asset('frontend/home/css/venobox.css')}}">
<!-- Nice Select CSS -->
<link rel="stylesheet" href="{{asset('frontend/home/css/nice-select.css')}}">
<!-- Magnific Popup CSS -->
<link rel="stylesheet" href="{{asset('frontend/home/css/magnific-popup.css')}}">
<!-- Bootstrap V4.1.3 Fremwork CSS -->
<link rel="stylesheet" href="{{asset('frontend/home/css/bootstrap.min.css')}}">
<!-- Helper CSS -->
<link rel="stylesheet" href="{{asset('frontend/home/css/helper.css')}}">
<!-- Main Style CSS -->
<link rel="stylesheet" href="{{asset('frontend/home/style.css')}}">
<!-- Responsive CSS -->
<link rel="stylesheet" href="{{asset('frontend/home/css/responsive.css')}}">
<!-- Modernizr js -->
<script src="frontend/home/js/vendor/modernizr-2.8.3.min.js"></script>
</head>
...
<body>
    ...
    <div class="body-wrapper">
                        ...
                        <div class="col-lg-3 col-md-4">
                            <div class="header-top-left">
                                <ul class="phone-wrap">
                                    ...
                                    <li><span>Phone Shop:</span><a href="#">0797643101</a></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3">
                            <div class="logo pb-sm-30 pb-xs-30">
                                <a href="{{URL::to('/trang-chu')}}">
                                    <img src="{{asset('frontend/home/images/menu/logo/4.jpg')}}" alt="">
                                </a>
                            </div>
                        </div>
                                ...
                                <nav>
                                    <ul>
                                        ...
                                        <li class="hb-info f-right p-0 d-sm-none d-lg-block">
                                            <span>65 Huỳnh Thúc Kháng, P.Bến Nghé, Q.1, Thành Phố Hồ Chí Minh</span>
                                        </li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="li-static-home-image">
                            <img src="{{asset('frontend/home/images/menu/logo/11.jpg')}}" alt="">
                        </div>
                    ...
                    <div class="footer-shipping pt-60 pb-55 pb-xs-25">
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6 pb-sm-55 pb-xs-55">
                                <div class="li-shipping-inner-box">
                                    <div class="shipping-icon">
                                        <img src="{{asset('frontend/home/images/shipping-icon/1.png')}}">
                                    </div>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6 pb-sm-55 pb-xs-55">
                                <div class="li-shipping-inner-box">
                                    <div class="shipping-icon">
                                        <img src="{{asset('frontend/home/images/shipping-icon/2.png')}}">
                                    </div>
                                    <div class="shipping-text">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6 pb-xs-30">
                                <div class="li-shipping-inner-box">
                                    <div class="shipping-icon">
                                        <img src="{{asset('frontend/home/images/shipping-icon/3.png')}}">
                                    </div>
                                    <div class="shipping-text">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6 pb-xs-30">
                                <div class="li-shipping-inner-box">
                                    <div class="shipping-icon">
                                        <img src="{{asset('frontend/home/images/shipping-icon/4.png')}}">
                                    </div>
                                    <div class="shipping-text">
        ...
        <!-- jQuery-V1.12.4 -->
        <script src="{{asset('frontend/home/js/vendor/jquery-1.12.4.min.js')}}"></script>
        <!-- Popper js -->
        <script src="{{asset('frontend/home/js/vendor/popper.min.js')}}"></script>
        <!-- Bootstrap V4.1.3 Fremwork js -->
        <script src="{{asset('frontend/home/js/bootstrap.min.js')}}"></script>
        <!-- Ajax Mail js -->
        <script src="{{asset('frontend/home/js/ajax-mail.js')}}"></script>
        <!-- Meanmenu js -->
        <script src="{{asset('frontend/home/js/jquery.meanmenu.min.js')}}"></script>
        <!-- Wow.min js -->
        ...
        <!-- Mixitup js -->
        <script src="{{asset('frontend/home/js/jquery.mixitup.min.js')}}"></script>
        <!-- Countdown -->
        <script src="{{asset('frontend/home/js/jquery.countdown.min.js')}}"></script>
        <!-- Counterup -->
        ...
        <!-- Barrating -->
        <script src="{{asset('frontend/home/js/jquery.barrating.min.js')}}"></script>
        <!-- Jquery-ui -->
        <script src="{{asset('frontend/home/js/jquery-ui.min.js')}}"></script>
        <!-- Venobox -->
        <script src="{{asset('frontend/home/js/venobox.min.js')}}"></script>
        <!-- Nice Select js -->
        <script src="{{asset('frontend/home/js/jquery.nice-select.min.js')}}"></script>
        <!-- ScrollUp js -->
        <script src="{{asset('frontend/home/js/scrollUp.min.js')}}"></script>
        <!-- Main/Activator js -->
